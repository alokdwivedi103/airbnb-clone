  ...
  return (
    <div className='checkout-parent'>
      ...
      <div className='place-datails-container absolute'>
        ...
        <Link to={`/${id}`}>
          <img src={homeMainPic} className="rounded-xl w-48 absolute checkout-pic" alt="home pic"/>
        ...
        <img src='https://a0.muscache.com/pictures/aircover/aircover-logo/original/56683a2f-f11b-43f6-8af7-a1b3861b2c85.svg' className='checkout-logo absolute w-32 left-12' alt = "checkout"/>

        ...
        <div className='footer2'>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p className='font-semibold text-2xl'> BUILT BY ALOK DWIVEDI<br /> </p>
                </div>
                <div className="md:place-self-center md:justify-self-end">
                    <div className="grid grid-flow-col gap-4">
                        <a href='https://twitter.com/Alok77993141' target={"_blank"}><TwitterIcon /></a>
                        <a href='https://www.linkedin.com/in/alok-dwivedi-b2a2901ba/'><LinkedInIcon /></a>
                        <a href='https://www.github.com/alokdwivedi103'><GitHubIcon /></a>
                    </div>
                </div>
            </footer>
        </div>
